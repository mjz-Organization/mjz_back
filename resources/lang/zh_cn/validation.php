...
return [
    ...
    */
    ...
    'required_if'          => ':attribute 字段不能为空当 :other 是 :value',
    'required_unless'      => ':attribute 字段不能为空，除非 :other 是在 :values 中',
    'required_with'        => ':attribute 字段不能为空当 :values 是存在的',
    'required_with_all'    => ':attribute 字段不能为空当 :values 是存在的',
    'required_without'     => ':attribute 字段不能为空当 :values 是不存在的',
    'required_without_all' => ':attribute 字段不能为空当 没有一个 :values 是存在的',
